...
public class AsGuildPanel_List : MonoBehaviour 
{
	...
	public void Init( System.Object data )
	{
		...
		if( null != AsUserInfo.Instance.GuildData && null != createBtn )
		{
			createBtn.SetControlState( UIButton.CONTROL_STATE.DISABLED );
			createBtn.spriteText.Color = Color.gray;
		}
	}

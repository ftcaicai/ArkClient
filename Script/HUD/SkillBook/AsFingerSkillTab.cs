...
public class AsFingerSkillTab : AsSkillTab
{
	...
	override public void Init( int npcID, bool flag)
	{
		...
		foreach( KeyValuePair<int, SkillView> pair in SkillBook.Instance.dicFinger)
		{
...
//		baseSkillItem.List = list;
		baseSkillItem.Init( _skill, SkillBook.Instance.newdicFinger.ContainsKey(_skill.nSkillTableIdx) );
	}
}

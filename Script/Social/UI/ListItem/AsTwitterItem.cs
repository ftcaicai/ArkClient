...
public class AsTwitterItem : MonoBehaviour {
	...
	private void m_InviteMsgBtnDelegate( ref POINTER_INFO ptr)
	{
		if( ptr.evt == POINTER_INFO.INPUT_EVENT.TAP)
		{
			...
			AsCommonSender.SendGameInvite( true, ( int)eGAME_INVITE_PLATFORM.eGAME_INVITE_PLATFORM_TWITTER, m_friendData.id.ToString());
		}
	}
